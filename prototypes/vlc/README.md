...
> Prototype only. This integration is not shipped with the web, server, extension, or iOS production surfaces.
...
```text
prototypes/vlc/polycast-clickable-subtitles.lua
```
